...
public interface EventOperationMapper {
    ...
    @Mapping(source = "startBookingDateTime", target = "startBookingDateTime")
    @Mapping(source = "endBookingDateTime", target = "endBookingDateTime")
    ...
    @Mapping(source = "createOperationDTO.startBookingDateTime", target = "startBookingDateTime")
    @Mapping(source = "createOperationDTO.endBookingDateTime", target = "endBookingDateTime")
